if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Zuka's Personal is already running!", 0)
    return
end
...
if makefolder and isfolder and writefile and isfile then
    pcall(function() -- good executor trust
        ...
        for _, folder in {"zukaiy", "z7ukasiy/assets"} do
...
ScaledHolder.BackgroundTransparency = 1.5
...
Title.Name = "VaporwaveTitle"
Title.Parent = Holder
Title.Active = true
Title.BackgroundTransparency = 1 -- Make background invisible
Title.Size = UDim2.new(0, 250, 0, 20)
Title.Font = Enum.Font.Arcade -- A more retro, 80s-style font
Title.TextSize = 20 -- Slightly larger for more impact
Title.TextColor3 = Color3.fromRGB(0, 255, 255) -- Bright cyan for the text
Title.Text = "ZUKA S  v" .. currentVersion -- Spaced-out for aesthetic

-- // Neon Glow Effect
local TitleGlow = Instance.new("UIStroke")
TitleGlow.Thickness = 2
TitleGlow.LineJoinMode = Enum.LineJoinMode.Round
TitleGlow.Color = Color3.fromRGB(255, 0, 255) -- Contrasting magenta for the glow
TitleGlow.Parent = Title

do
	local emoji = ({
		["01 01"] = "￯﾿ﾯ￯ﾾ﾿￯ﾾﾰ￯﾿ﾯ￯ﾾﾾ￯ﾾﾟ￯﾿ﾯ￯ﾾﾾ￯ﾾﾎ￯﾿ﾯ￯ﾾﾾ￯ﾾﾆ",
		[(function(Year)
		...
		end)(tonumber(os.date"%Y"))] = "￯﾿ﾯ￯ﾾ﾿￯ﾾﾰ￯﾿ﾯ￯ﾾﾾ￯ﾾﾟ￯﾿ﾯ￯ﾾﾾ￯ﾾﾥ￯﾿ﾯ￯ﾾﾾ￯ﾾﾚ",
		["10 31"] = "￯﾿ﾯ￯ﾾ﾿￯ﾾﾰ￯﾿ﾯ￯ﾾﾾ￯ﾾﾟ￯﾿ﾯ￯ﾾﾾ￯ﾾﾎ￯﾿ﾯ￯ﾾﾾ￯ﾾﾃ",
		["12 25"] = "￯﾿ﾯ￯ﾾ﾿￯ﾾﾰ￯﾿ﾯ￯ﾾﾾ￯ﾾﾟ￯﾿ﾯ￯ﾾﾾ￯ﾾﾎ￯﾿ﾯ￯ﾾﾾ￯ﾾﾄ"
	})[os.date("%m %d")]
	if emoji then
...
task.spawn(function()
	...
	if success then
		...
		local function Index()
			if chatbox.Text:lower():sub(1,6) == prefix then
				if SettingsOpen == true then
					wait(0.2)
					CMDsF.Visible = true
					Settings:TweenPosition(UDim2.new(0, 0, 0, 220), "InOut", "Quart", 0.2, true, nil)
				end
				IndexContents(PlayerGui.Chat.Frame.ChatBarParentFrame.Frame.BoxFrame.Frame.ChatBar.Text:lower():sub(7),true)
			else
				minimizeHolder()
				if SettingsOpen == true then
					wait(0.2)
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'zukaui / zhub / help', DESC = 'Opens My Personal Gui.'}
...
CMDs[#CMDs + 1] = {NAME = 'gearsedit / gedit', DESC = 'Opens Hitbox Modifier'}
...
CMDs[#CMDs + 1] = {NAME = 'zuka / zui', DESC = 'Zukas GUI'}
...
addcmd("zukaui", {"zhub"}, function(args, speaker)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptlisenbe-stack/luaprojectse3/refs/heads/main/ZukasExecutor.lua"))()
end)
...
addcmd("explorer", {"dex"}, function(args, speaker)
    notify("Loading", "Hold on a sec")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptlisenbe-stack/luaprojectse3/refs/heads/main/CustomDex.lua"))()
end)
...
addcmd('editgears',{'gedit'},function(args, speaker)
	notify("Loading",'Hold on a sec')
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/scriptlisenbe-stack/luaprojectse3/refs/heads/main/Tool%20Modifier.lua'),true))()
end)
