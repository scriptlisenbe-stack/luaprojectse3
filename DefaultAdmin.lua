...
-- Command Definitions
--==============================================================================
table.insert(CommandInfo, { Name = "cmds", Aliases = {"help"}, Description = "Shows this command list."}); table.insert(CommandInfo, { Name = "speed", Aliases = {}, Description = "Sets walkspeed. Usage: ;speed [num]"}); table.insert(CommandInfo, { Name = "fly", Aliases = {}, Description = "Toggles smooth flight mode."}); table.insert(CommandInfo, { Name = "flyspeed", Aliases = {}, Description = "Sets flight speed. Usage: ;flyspeed [num]"}); table.insert(CommandInfo, { Name = "noclip", Aliases = {}, Description = "Toggles walking through walls."}); table.insert(CommandInfo, { Name = "clickfling", Aliases = {"mousefling"}, Description = "Enables click to fling."}); table.insert(CommandInfo, { Name = "unclickfling", Aliases = {"unmousefling"}, Description = "Disables click to fling."}); table.insert(CommandInfo, { Name = "scripthub", Aliases = {"hub"}, Description = "Opens a script hub GUI."}); table.insert(CommandInfo, { Name = "teleportgui", Aliases = {"tpui", "uviewer"}, Description = "Opens a universe teleport GUI."}); table.insert(CommandInfo, { Name = "reach", Aliases = {"swordreach"}, Description = "Extends sword reach. Usage: ;reach [num]"}); table.insert(CommandInfo, { Name = "boxreach", Aliases = {}, Description = "Creates a box hitbox. Usage: ;boxreach [num]"}); table.insert(CommandInfo, { Name = "resetreach", Aliases = {"unreach"}, Description = "Resets tool reach to normal."}); table.insert(CommandInfo, { Name = "aura", Aliases = {}, Description = "Auto-hits nearby players. Usage: ;aura [dist]"}); table.insert(CommandInfo, { Name = "unaura", Aliases = {}, Description = "Disables aura."}); table.insert(CommandInfo, { Name = "devpanel", Aliases = {"dpanel"}, Description = "Opens a powerful developer/debugging panel."})
...
Commands.scripthub = function() pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/ltseverydayyou/Nameless-Admin/main/ScriptHubNA.lua"))() end) end
Commands.teleportgui = function() pcall(function() loadstring(game:HttpGet("https://raw.githubusercontent.com/ltseverydayyou/uuuuuuu/main/Universe%20Viewer"))() end) end
Commands.devpanel = function() pcall(function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Script-Dev-Panel-Moonsec-Deobfuscator-dex-simple-spy-remote-62809"))() end) end

-- Command wrappers for modules
Commands.fly = function() Modules.Fly:Toggle() end; Commands.flyspeed = function(args) Modules.Fly:SetSpeed(args[1]) end; Commands.noclip = function() Modules.Noclip:Toggle() end; Commands.clickfling = function() Modules.ClickFling:Enable() end; Commands.unclickfling = function() Modules.ClickFling:Disable() end; Commands.cmds = function() Modules.CommandsUI:Toggle() end; Commands.reach = function(args) Modules.Reach:Apply("directional", tonumber(args[1]) or 15) end; Commands.boxreach = function(args) Modules.Reach:Apply("box", tonumber(args[1]) or 15) end; Commands.resetreach = function() Modules.Reach:Reset() end; Commands.aura = function(args) Modules.Aura:Enable(args[1]) end; Commands.unaura = function() Modules.Aura:Disable() end

-- Command Aliases
Commands.help = Commands.cmds; Commands.hub = Commands.scripthub; Commands.tpui = Commands.teleportgui; Commands.uviewer = Commands.teleportgui; Commands.mousefling = Commands.clickfling; Commands.unmousefling = Commands.unclickfling; Commands.swordreach = Commands.reach; Commands.unreach = Commands.resetreach; Commands.dpanel = Commands.devpanel

--==============================================================================
-- Command Handler
--==============================================================================
LocalPlayer.Chatted:Connect(function(message) if not message:sub(1, #Prefix) == Prefix then return end; local args = {}; for word in message:sub(#Prefix + 1):gmatch("%S+") do table.insert(args, word) end; if #args == 0 then return end; local cmdName = table.remove(args, 1):lower(); local cmdFunc = Commands[cmdName]; if cmdFunc then pcall(cmdFunc, args) else DoNotif("Unknown command: " .. cmdName, 3) end end)

DoNotif("Zuka command handler v3 loaded. Prefix is '" .. Prefix .. "'. Type ;cmds for a list.", 5)